...
public class DonationDbRepository implements DonationRepository {
    ...
    private CharityCaseRepository charityCaseRepo;

    public DonationDbRepository(Properties props, DonorRepository donorRepo, CharityCaseRepository charityCaseRepo) {
